 ...
 */
@ServerEndpoint(path = "/obs-ws", port = "${ws.port2}")
public class ObstacleWebSocket {
     ...
     */
    private static CopyOnWriteArraySet<ObstacleWebSocket> webSocketSet = new CopyOnWriteArraySet<>();
...
/*    @BeforeHandshake
    ...
    public static void sendInfoToClient(String message) throws IOException {
        for (ObstacleWebSocket myWebSocket : webSocketSet) {
