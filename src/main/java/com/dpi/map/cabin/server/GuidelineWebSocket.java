 ...
 */
@ServerEndpoint(path = "/guide-ws", port = "${ws.port1}")
public class GuidelineWebSocket {
     ...
     */
    private static CopyOnWriteArraySet<GuidelineWebSocket> webSocketSet = new CopyOnWriteArraySet<>();
...
/*    @BeforeHandshake
    ...
    public static void sendInfoToClient(String message) throws IOException {
        for (GuidelineWebSocket myWebSocket : webSocketSet) {
