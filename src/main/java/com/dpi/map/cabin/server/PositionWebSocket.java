 ...
 */
@ServerEndpoint(path = "/position-ws", port = "${ws.port3}")
public class PositionWebSocket {
     ...
     */
    private static CopyOnWriteArraySet<PositionWebSocket> webSocketSet = new CopyOnWriteArraySet<>();
...
/*    @BeforeHandshake
    ...
    public static void sendInfoToClient(String message) throws IOException {
        for (PositionWebSocket myWebSocket : webSocketSet) {
