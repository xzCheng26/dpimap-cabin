 ...
 */
@ServerEndpoint(path = "/speed-ws", port = "${ws.port4}")
public class SpeedWebSocket {
     ...
     */
    private static CopyOnWriteArraySet<SpeedWebSocket> webSocketSet = new CopyOnWriteArraySet<>();
...
/*    @BeforeHandshake
    ...
    public static void sendInfoToClient(String message) throws IOException {
        for (SpeedWebSocket myWebSocket : webSocketSet) {
